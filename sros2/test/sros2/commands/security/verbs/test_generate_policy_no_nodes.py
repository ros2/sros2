...
class TestSROS2GeneratePolicyVerbWithNoNodes(SROS2CLITestCase):
    ...
    # Attribute injected onto the class at runtime by SROS2CLITestCase.setUpClass.
    launch_sros2_command: Any

    def test_generate_policy_no_nodes(self) -> None:
    ...
    def test_generate_policy_no_policy_file(self) -> None:
